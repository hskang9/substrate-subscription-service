...
decl_storage! {
	trait Store for Module<T: Trait> as TemplateModule {
		...
		Calls get(call): map T::BlockNumber => Vec<(T::AccountId, T::Hash)>;
		SubscriptionOf: map (T::AccountId, T::Hash) => Option<SubscriptionInfo<T::Balance, T::AccountId, T::Hash, T::BlockNumber>>; 
	}
}
